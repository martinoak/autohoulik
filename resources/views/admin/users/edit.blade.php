        ...
        <div class="divide-y divide-gray-900/10 dark:divide-white/10">
            <div class="grid grid-cols-1 gap-x-8 gap-y-8 py-10 md:grid-cols-3">
                <div class="px-4 sm:px-0">
                    <h2 class="text-base/7 font-semibold text-gray-900 dark:text-white">Upravit uživatele</h2>
                    <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-400">Aktualizujte informace o uživateli.</p>
                </div>
                ...
                <div class="bg-white shadow-xs outline outline-gray-900/5 sm:rounded-xl md:col-span-2 dark:bg-[#212121] dark:shadow-none dark:-outline-offset-1 dark:outline-white/10">
                    <div class="px-4 py-6 sm:p-8">
                        <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-6">
                                <label for="password" class="block text-sm/6 font-medium text-gray-900 dark:text-white">Nové heslo</label>
                                <div class="mt-2">
                                    <input id="password"
                                           type="password"
                                           name="password"
                                ...
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Nechte prázdné, pokud nechcete měnit heslo</p>
                                @error('password')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="sm:col-span-6">
                                <label for="password_confirmation" class="block text-sm/6 font-medium text-gray-900 dark:text-white">Potvrzení nového hesla</label>
                                <div class="mt-2">
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                ...
                <button type="submit" class="primary large">Aktualizovat uživatele</button>
            </div>
        </div>
    </form>
@endsection
